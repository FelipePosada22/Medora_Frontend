...
export class AppointmentTypesService {
  ...
  update(id: string, payload: Partial<AppointmentTypePayload>): Observable<AppointmentType> {
    return this.api.update(id, payload).pipe(map(AppointmentTypeMapper.toDomain));
  }
